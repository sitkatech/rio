drop table dbo.CimisPrecipitationDatum

delete 
from dbo.ParcelLedger
where ParcelLedgerEntrySourceTypeID = 3

delete 
from dbo.ParcelLedgerEntrySourceType
where ParcelLedgerEntrySourceTypeID = 3

drop procedure dbo.pPublishCimisPrecipitationDataToParcelLedger
go

ALTER procedure [dbo].[pParcelWaterSupplyAndUsage]
(
    @year int
)
as
