...
CREATE TABLE [dbo].[ParcelAllocationType](
	...
	[ParcelAllocationTypeDisplayName] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
(
 ...
 CONSTRAINT [AK_ParcelAllocationType_ParcelAllocationTypeDisplayName] UNIQUE NONCLUSTERED 
(
	[ParcelAllocationTypeDisplayName] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
