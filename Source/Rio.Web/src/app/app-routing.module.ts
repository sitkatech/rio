...
const routes: Routes = [
  ...
  { path: "market-metrics", component: MarketMetricsHomeComponent, canActivate: [UnauthenticatedAccessGuard, AllowTradeGuard, ManagerOnlyGuard, AcknowledgedDisclaimerGuard] },
  ...
  { path: "about-groundwater-evaluation", component: AboutGroundwaterEvaluationComponent, canActivate: [UnauthenticatedAccessGuard]},
  { path: "managed-recharge-scenario", component: ManagedRechargeScenarioComponent, canActivate: [UnauthenticatedAccessGuard]},
  { path: "water-trading-scenario", component: WaterTradingScenarioComponent, canActivate: [UnauthenticatedAccessGuard]},
