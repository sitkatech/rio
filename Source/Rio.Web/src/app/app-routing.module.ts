...
const routes: Routes = [
  ...
  { path: "add-water-accounts", component: WaterAccountsAddComponent, canActivate: [UnauthenticatedAccessGuard, AcknowledgedDisclaimerGuard] },
  { path: "manage-water-accounts", component: WaterAccountsManageComponent, canActivate: [UnauthenticatedAccessGuard, AcknowledgedDisclaimerGuard] },
  ...
  { path: "create-user-profile", component: SignUpComponent },
